...
def parameters():
    ...
    params.use_active_online_summary = True
    params.use_active_online_extremum = False
    params.train_from_previous = False
    params.use_rnd_query = True
    params.random_query_probability = 0.03 # ~1 fps queries @30fps is 0.03

    # Oracle parameters
    params.use_oracle_feedback = True
    params.use_oracle_iou = True
    params.use_oracle_prec = False
    params.oracle_iou_threshold = 0.8
    ...
    params.dist_func = "l2_dist" # "cosine_dist", "l2_normalised_dist", "l2_dist"
