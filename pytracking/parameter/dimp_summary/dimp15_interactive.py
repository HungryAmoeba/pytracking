...
def parameters():
    ...
    params.summary_rel_weight = .5 #the weight of each summary image
                                    # in comparison to ground truth
                                    # greater than 1 indicates summary images
                                    # are more important than ground truth
